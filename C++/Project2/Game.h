...
**
** This file contains the first major class's (Game) prototype declarations.
**
***********************************************/
...
const int NUM_OF_RAW_MATERIALS = 17; // Number of indices with a searchable raw material
...
public:
  ...
  */
  ...
  // Name: SearchRecipes(string, string)
