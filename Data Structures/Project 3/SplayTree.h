 ...
 *
 * SplayTree Class definition and implementation.
 *
 *************************************************************/
...
// Comparable getNode ( x ) --> Returns the node if found
// void printSubString( x ) --> Prints all Nodes with the substring
// void printRoot( )        --> Prints the root Node
...
class SplayTree
{
  public:
     ...
     */
    Comparable * getNode( const Comparable & x )
    {
        return &root->element;
    }
    ...
    /**
     * Prints Nodes containing the passed substring.
     */
    void printSubString( Comparable &x ) const
    {
        if( isEmpty( ) )
            cout << "This tree has no Nodes" << endl;
        else
            printSubString( root, x );
    }
    ...
    void printRoot( ) const
    {
        if( isEmpty( ) )
            ...
            cout << "This tree starts with " << root->element
            << " and has " << countNodes()  << " nodes\n";
    }
...
private:
   ...
   void printTree( BinaryNode *t ) const
    ...
    /**
     * Internal method to print a Node containing a substring.
     */
    void printSubString( BinaryNode *t, Comparable &x ) const
    {
        if( t != t->left )
        {
            printSubString( t->left, x );
            if( x % t->element ) { cout << t->element << endl; }
            printSubString( t->right, x );
        }
    }


    /**
     * Internal method to count the number of nodes in the splay tree.
     */
